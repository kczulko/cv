...
\quote{\itshape Software engineer with >15 years of overall experience}

%\cvpicture{./samplepic.jpg}
% Add up to 10 assets (0 to 9)
\setcvasset[0]{\emph{Experienced} software developer}
\setcvasset[1]{\emph{Build} systems}
\setcvasset[2]{\emph{Functional} programming}
\setcvasset[3]{\emph{Knowledge} sharing}
\setcvcontact[email]{karol.czulkowski@protonmail.com}
