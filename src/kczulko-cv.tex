...
\story{functional engineer}
      ...
      {10.2021 - now\\Remote}
      {bazel, haskell, scala\\golang, akka-typed}
      { Tweag is a software innovation lab from France gathering people around
        ...
        \begin{missions}
          \item Contribution to \href{https://github.com/tweag/gazelle_cabal}{https://github.com/tweag/gazelle\_cabal}
          \item Work for a \href{https://www.heb.com}{H-E-B} client (grocery retail from Texas)
        \end{missions}
      }
%----------------------------------------------------------------------------
\story{scala developer}
      ...
      {Member of Next Generation Archive solution team. Delivering a system designed to store banking documents.
        It is a typical CRUD web-based application build on the top of Hitachi database solution.
...
\story{scala developer}
      ...
      {Development of HDFS metadata indexing hub (proprietary solution akin to \href{https://egeria.odpi.org}{egeria}).
        ...
        \begin{missions}
        \item I've introduced and taught internal workers modern FP architecture
